        ...
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            <BlockTitle tag="h2" className="fw-normal">
              Transaction Menu Accesss
            </BlockTitle>
            <BlockDes>
              <p className="lead">
              Transaction Menu Accesss is used to view a list of job applicants who have applied for job openings. It includes various features such as search and adding data to open job vacancies.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
