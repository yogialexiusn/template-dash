      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Transaction Change Request is used to view a list of job applicants who have applied for job openings.
                It includes various features such as search and adding data to open job vacancies.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
